...
import com.nda.jooq.generated.sys.tables.records.SchemaTableStatisticsRecord;
...
public class SchemaTableStatistics extends TableImpl<SchemaTableStatisticsRecord> {
    ...
    private static final long serialVersionUID = -1988627856;
     ...
     */
    public final TableField<SchemaTableStatisticsRecord, String> TOTAL_LATENCY = createField("total_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<SchemaTableStatisticsRecord, String> FETCH_LATENCY = createField("fetch_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<SchemaTableStatisticsRecord, String> INSERT_LATENCY = createField("insert_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<SchemaTableStatisticsRecord, String> UPDATE_LATENCY = createField("update_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<SchemaTableStatisticsRecord, String> DELETE_LATENCY = createField("delete_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<SchemaTableStatisticsRecord, String> IO_READ = createField("io_read", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");

    /**
     * The column <code>sys.schema_table_statistics.io_read_latency</code>.
     */
    public final TableField<SchemaTableStatisticsRecord, String> IO_READ_LATENCY = createField("io_read_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<SchemaTableStatisticsRecord, String> IO_WRITE = createField("io_write", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");

    /**
     * The column <code>sys.schema_table_statistics.io_write_latency</code>.
     */
    public final TableField<SchemaTableStatisticsRecord, String> IO_WRITE_LATENCY = createField("io_write_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<SchemaTableStatisticsRecord, String> IO_MISC_LATENCY = createField("io_misc_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");
