...
public class SlaveWorkerInfoRecord extends UpdatableRecordImpl<SlaveWorkerInfoRecord> implements Record13<UInteger, String, ULong, String, ULong, String, ULong, String, ULong, UInteger, UInteger, byte[], String> {
    ...
    private static final long serialVersionUID = -160137580;
    ...
    /**
     * Setter for <code>mysql.slave_worker_info.Channel_name</code>. The channel on which the replica is connected to a source. Used in Multisource Replication
     */
    ...
    /**
     * Getter for <code>mysql.slave_worker_info.Channel_name</code>. The channel on which the replica is connected to a source. Used in Multisource Replication
     */
