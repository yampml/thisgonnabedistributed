...
import com.nda.jooq.generated.sys.tables.records.X$statementsWithRuntimesIn_95thPercentileRecord;
...
public class X$statementsWithRuntimesIn_95thPercentile extends TableImpl<X$statementsWithRuntimesIn_95thPercentileRecord> {
    ...
    private static final long serialVersionUID = 1641616579;
     ...
     */
    public final TableField<X$statementsWithRuntimesIn_95thPercentileRecord, Timestamp> FIRST_SEEN = createField("first_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");

    /**
     * The column <code>sys.x$statements_with_runtimes_in_95th_percentile.last_seen</code>.
     */
    public final TableField<X$statementsWithRuntimesIn_95thPercentileRecord, Timestamp> LAST_SEEN = createField("last_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");
