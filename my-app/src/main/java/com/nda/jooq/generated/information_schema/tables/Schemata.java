...
import com.nda.jooq.generated.information_schema.tables.records.SchemataRecord;
...
public class Schemata extends TableImpl<SchemataRecord> {
    ...
    private static final long serialVersionUID = 1254328043;
     ...
     */
    public final TableField<SchemataRecord, SchemataDefaultEncryption> DEFAULT_ENCRYPTION = createField("DEFAULT_ENCRYPTION", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.nda.jooq.generated.information_schema.enums.SchemataDefaultEncryption.class), this, "");
