...
import com.nda.jooq.generated.sys.tables.records.SchemaAutoIncrementColumnsRecord;
...
public class SchemaAutoIncrementColumns extends TableImpl<SchemaAutoIncrementColumnsRecord> {
    ...
    private static final long serialVersionUID = -1832955360;
     ...
     */
    public final TableField<SchemaAutoIncrementColumnsRecord, String> TABLE_SCHEMA = createField("table_schema", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>sys.schema_auto_increment_columns.table_name</code>.
     */
    public final TableField<SchemaAutoIncrementColumnsRecord, String> TABLE_NAME = createField("table_name", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
