...
public class X$userSummaryByStatementTypeRecord extends TableRecordImpl<X$userSummaryByStatementTypeRecord> implements Record11<String, String, ULong, ULong, ULong, ULong, ULong, ULong, ULong, ULong, ULong> {

    private static final long serialVersionUID = -573686962;
    ...
    /**
     * Setter for <code>sys.x$user_summary_by_statement_type.cpu_latency</code>.
     */
    ...
    /**
     * Getter for <code>sys.x$user_summary_by_statement_type.cpu_latency</code>.
     */
    ...
    public Field<ULong> field7() {
        return X$userSummaryByStatementType.X$USER_SUMMARY_BY_STATEMENT_TYPE.CPU_LATENCY;
    }
     ...
     */
    @Override
    public X$userSummaryByStatementTypeRecord value11(ULong value) {
        setFullScans(value);
        return this;
    }
     ...
     */
    @Override
    public X$userSummaryByStatementTypeRecord values(String value1, String value2, ULong value3, ULong value4, ULong value5, ULong value6, ULong value7, ULong value8, ULong value9, ULong value10, ULong value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public X$userSummaryByStatementTypeRecord(String user, String statement, ULong total, ULong totalLatency, ULong maxLatency, ULong lockLatency, ULong cpuLatency, ULong rowsSent, ULong rowsExamined, ULong rowsAffected, ULong fullScans) {
        super(X$userSummaryByStatementType.X$USER_SUMMARY_BY_STATEMENT_TYPE);
