...
import com.nda.jooq.generated.sys.tables.records.SessionRecord;
...
public class Session extends TableImpl<SessionRecord> {
    ...
    private static final long serialVersionUID = 1689555163;
     ...
     */
    public final TableField<SessionRecord, String> STATEMENT_LATENCY = createField("statement_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<SessionRecord, String> LOCK_LATENCY = createField("lock_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");

    /**
     * The column <code>sys.session.cpu_latency</code>.
     */
    public final TableField<SessionRecord, String> CPU_LATENCY = createField("cpu_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<SessionRecord, String> LAST_STATEMENT_LATENCY = createField("last_statement_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");

    /**
     * The column <code>sys.session.current_memory</code>.
     */
    public final TableField<SessionRecord, String> CURRENT_MEMORY = createField("current_memory", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");
     ...
     */
    public final TableField<SessionRecord, String> LAST_WAIT_LATENCY = createField("last_wait_latency", org.jooq.impl.SQLDataType.VARCHAR(13), this, "");
     ...
     */
    public final TableField<SessionRecord, String> TRX_LATENCY = createField("trx_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");

    /**
     * The column <code>sys.session.trx_state</code>.
     */
    public final TableField<SessionRecord, SessionTrxState> TRX_STATE = createField("trx_state", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.nda.jooq.generated.sys.enums.SessionTrxState.class), this, "");

    /**
     * The column <code>sys.session.trx_autocommit</code>.
     */
    public final TableField<SessionRecord, SessionTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.impl.SQLDataType.VARCHAR(3).asEnumDataType(com.nda.jooq.generated.sys.enums.SessionTrxAutocommit.class), this, "");
