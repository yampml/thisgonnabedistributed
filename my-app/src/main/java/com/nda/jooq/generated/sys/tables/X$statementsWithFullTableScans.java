...
import com.nda.jooq.generated.sys.tables.records.X$statementsWithFullTableScansRecord;
...
public class X$statementsWithFullTableScans extends TableImpl<X$statementsWithFullTableScansRecord> {
    ...
    private static final long serialVersionUID = -1034375143;
     ...
     */
    public final TableField<X$statementsWithFullTableScansRecord, Timestamp> FIRST_SEEN = createField("first_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");

    /**
     * The column <code>sys.x$statements_with_full_table_scans.last_seen</code>.
     */
    public final TableField<X$statementsWithFullTableScansRecord, Timestamp> LAST_SEEN = createField("last_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");
