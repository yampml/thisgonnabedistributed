...
public class EventsStatementsSummaryByHostByEventName extends TableImpl<EventsStatementsSummaryByHostByEventNameRecord> {
    ...
    private static final long serialVersionUID = -1688965554;
    ...
    /**
     * The column <code>performance_schema.events_statements_summary_by_host_by_event_name.SUM_CPU_TIME</code>.
     */
    public final TableField<EventsStatementsSummaryByHostByEventNameRecord, ULong> SUM_CPU_TIME = createField("SUM_CPU_TIME", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");
