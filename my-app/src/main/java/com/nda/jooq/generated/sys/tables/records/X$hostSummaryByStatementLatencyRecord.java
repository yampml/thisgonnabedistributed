...
public class X$hostSummaryByStatementLatencyRecord extends TableRecordImpl<X$hostSummaryByStatementLatencyRecord> implements Record10<String, BigInteger, BigInteger, ULong, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger> {

    private static final long serialVersionUID = 1492935270;
    ...
    /**
     * Setter for <code>sys.x$host_summary_by_statement_latency.cpu_latency</code>.
     */
    ...
    /**
     * Getter for <code>sys.x$host_summary_by_statement_latency.cpu_latency</code>.
     */
     ...
     */
    @Override
    public Row10<String, BigInteger, BigInteger, ULong, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger> fieldsRow() {
     ...
     */
    @Override
    public Row10<String, BigInteger, BigInteger, ULong, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger> valuesRow() {
    ...
    public Field<BigInteger> field6() {
        return X$hostSummaryByStatementLatency.X$HOST_SUMMARY_BY_STATEMENT_LATENCY.CPU_LATENCY;
    }
     ...
     */
    @Override
    public X$hostSummaryByStatementLatencyRecord value10(BigInteger value) {
        setFullScans(value);
        return this;
    }
     ...
     */
    @Override
    public X$hostSummaryByStatementLatencyRecord values(String value1, BigInteger value2, BigInteger value3, ULong value4, BigInteger value5, BigInteger value6, BigInteger value7, BigInteger value8, BigInteger value9, BigInteger value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public X$hostSummaryByStatementLatencyRecord(String host, BigInteger total, BigInteger totalLatency, ULong maxLatency, BigInteger lockLatency, BigInteger cpuLatency, BigInteger rowsSent, BigInteger rowsExamined, BigInteger rowsAffected, BigInteger fullScans) {
        super(X$hostSummaryByStatementLatency.X$HOST_SUMMARY_BY_STATEMENT_LATENCY);
