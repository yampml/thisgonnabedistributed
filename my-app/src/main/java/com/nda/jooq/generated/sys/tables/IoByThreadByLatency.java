...
import com.nda.jooq.generated.sys.tables.records.IoByThreadByLatencyRecord;
...
public class IoByThreadByLatency extends TableImpl<IoByThreadByLatencyRecord> {
    ...
    private static final long serialVersionUID = -1886300479;
     ...
     */
    public final TableField<IoByThreadByLatencyRecord, String> TOTAL_LATENCY = createField("total_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");

    /**
     * The column <code>sys.io_by_thread_by_latency.min_latency</code>.
     */
    public final TableField<IoByThreadByLatencyRecord, String> MIN_LATENCY = createField("min_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");

    /**
     * The column <code>sys.io_by_thread_by_latency.avg_latency</code>.
     */
    public final TableField<IoByThreadByLatencyRecord, String> AVG_LATENCY = createField("avg_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");

    /**
     * The column <code>sys.io_by_thread_by_latency.max_latency</code>.
     */
    public final TableField<IoByThreadByLatencyRecord, String> MAX_LATENCY = createField("max_latency", org.jooq.impl.SQLDataType.VARCHAR(11), this, "");
