...
import com.nda.jooq.generated.sys.tables.records.X$schemaTableStatisticsWithBufferRecord;
...
public class X$schemaTableStatisticsWithBuffer extends TableImpl<X$schemaTableStatisticsWithBufferRecord> {
    ...
    private static final long serialVersionUID = 2047876143;
     ...
     */
    public final TableField<X$schemaTableStatisticsWithBufferRecord, BigInteger> INNODB_BUFFER_ALLOCATED = createField("innodb_buffer_allocated", org.jooq.impl.SQLDataType.DECIMAL_INTEGER.precision(44), this, "");

    /**
     * The column <code>sys.x$schema_table_statistics_with_buffer.innodb_buffer_data</code>.
     */
    public final TableField<X$schemaTableStatisticsWithBufferRecord, BigInteger> INNODB_BUFFER_DATA = createField("innodb_buffer_data", org.jooq.impl.SQLDataType.DECIMAL_INTEGER.precision(44), this, "");

    /**
     * The column <code>sys.x$schema_table_statistics_with_buffer.innodb_buffer_free</code>.
     */
    public final TableField<X$schemaTableStatisticsWithBufferRecord, BigInteger> INNODB_BUFFER_FREE = createField("innodb_buffer_free", org.jooq.impl.SQLDataType.DECIMAL_INTEGER.precision(45), this, "");
     ...
     */
    public final TableField<X$schemaTableStatisticsWithBufferRecord, BigInteger> INNODB_BUFFER_ROWS_CACHED = createField("innodb_buffer_rows_cached", org.jooq.impl.SQLDataType.DECIMAL_INTEGER.precision(45).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.DECIMAL_INTEGER)), this, "");
