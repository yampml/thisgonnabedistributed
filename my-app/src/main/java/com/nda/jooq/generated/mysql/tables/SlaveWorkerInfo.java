...
public class SlaveWorkerInfo extends TableImpl<SlaveWorkerInfoRecord> {
    ...
    private static final long serialVersionUID = -997402254;
    ...
    /**
     * The column <code>mysql.slave_worker_info.Channel_name</code>. The channel on which the replica is connected to a source. Used in Multisource Replication
     */
    public final TableField<SlaveWorkerInfoRecord, String> CHANNEL_NAME = createField("Channel_name", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "The channel on which the replica is connected to a source. Used in Multisource Replication");
